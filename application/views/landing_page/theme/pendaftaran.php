                    ...
                    <div class="col-md-12">
                      <div class="mb-3">
                        <label for="file" class="drop-container">
                          ...
                          or
                          <input type="file" id="file" name="file" accept="application/pdf, application/msword, application/vnd.openxmlformats-officedocument.wordprocessingml.document, image/gif, image/jpeg, image/png" required 
                          style="width: 350px;
                                max-width: 100%;
                                color: #444;
                                padding: 5px;
...
.col-sm {
  flex: 0 0 20%; /* Adjust this value as needed */
  max-width: 20%; /* Adjust this value as needed */
  padding: 10px;
