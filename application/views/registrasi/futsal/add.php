        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('registrasi_futsal') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart('registrasi_futsal/add'); ?>
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <?php foreach ($event as $e) : ?>
                                ...
                                $selected = $e['nama_event'] == 'Futsal' ? $e['id_event'] : '';
                                ?>
                                <?php if ($e['nama_event'] == 'Futsal') : ?>
